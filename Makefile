...
KBUILD_CFLAGS   := -Wno-all -Wno-error -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -pipe \
...
clang-specific-configs := LTO_CLANG CFI_CLANG SHADOW_CALL_STACK INIT_STACK_ALL FORTIFY_SOURCE
